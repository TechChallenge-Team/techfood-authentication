...
namespace TechFood.Authentication.Infra.Migrations
{
    ...
    [Migration("20251110223746_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechFood.Authentication.Domain.Entities.ServiceClient", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("TechFood.Authentication.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TechFood.Authentication.Domain.Entities.User", b =>
                {
                    b.OwnsOne("TechFood.Authentication.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsOne("TechFood.Authentication.Domain.ValueObjects.Name", "Name", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
